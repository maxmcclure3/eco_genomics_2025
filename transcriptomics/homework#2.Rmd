...
res_G1_GO_sig <- subset(res_G1_GO, padj < 0.9 & abs(log2FoldChange) > 0.2)
...
# Convert to data frame
res_G2_df <- as.data.frame(resG3_CvT_HW)
...
# Keep only significant DEGs 
res_G2_GO_sig <- subset(res_G2_GO, padj < 0.9 & abs(log2FoldChange) > 0.05)
