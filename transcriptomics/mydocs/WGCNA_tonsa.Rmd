...
MEmidnightblue_summary <- summarySE(module_eigengene.metadata, measurevar="MElightcyan", groupvars=c("generation","line"))

MEmidnightblue_summary <- MEmidnightblue_summary %>%
...
ggplot(MEmidnightblue_summary, aes(x=as.factor(generation), y=MElightcyan, color=line, fill = line, shape = line)) +
