...
table_data <- tibble(
  ...
  minD = c(ST0stats$minD, ST1stats$minD,
                ...
                ST0_SMDI2stats$minD),
  BigD = c(ST0stats$BigD, ST1stats$BigD,
                SMDI1stats$BigD, SMDI2stats$BigD, 
                ST0_SMDI2stats$BigD),
  SmallD = c(ST0stats$SmallD, ST1stats$SmallD,
                SMDI1stats$SmallD, SMDI2stats$SmallD, 
                ST0_SMDI2stats$SmallD)
)
gtable <- table_data %>%
  gt() %>%
  tab_header(
  ...
  cols_label( 
    ...
    BigD = "Contig with largest Tajima's D",
    SmallD = "Contig with smallest Tajima's D"
    ) %>% 
  fmt_auto(table_data, 
