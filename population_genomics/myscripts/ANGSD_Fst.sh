...
#SBATCH --output=/users/m/r/mrmcclur/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
## will use ANGSD to estimate Fst between my red spruce pop 
## and black spruce outgroup

# Path to the `population_genomics` folder in your repo

REPO="/users/m/r/mrmcclur/projects/eco_genomics_2025/population_genomics"
...
#major computational step of the program
realSFS \
