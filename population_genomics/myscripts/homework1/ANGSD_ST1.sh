...
mkdir ~/projects/eco_genomics_2025/population_genomics/mydata/homework1data/ST1

INPUT="/gpfs1/cl/ecogen/pbio6800/PopulationGenomics/bams"

OUT="/users/m/r/mrmcclur/projects/eco_genomics_2025/population_genomics/mydata/homework1data/ST1"
