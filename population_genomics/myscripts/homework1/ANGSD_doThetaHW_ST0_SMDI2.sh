...
mkdir ${REPO}/myresults/homework1results

INPUT="${REPO}/mydata/homework1data/ST0_SMDI2"

OUT="${REPO}/myresults/homework1results"

REF="/gpfs1/cl/ecogen/pbio6800/PopulationGenomics/ref_genome/Pmariana/Pmariana1.0-genome_reduced.fa"

MYPOP="2032"

SUFFIX="ALL_ST0_SMDI2"   # All sites (=ALL) or just polymorphic sites (=POLY)?
